...
{
    /**
     * @Route("/pdfreclamation", name="pdfreclamation",methods={"GET"})
     */
    public function pdf(ReclamationRepository  $reclamationRepository):Response
    {
        ...
        $html = $this->renderView('extras/pdfreclamation.html.twig', [
    ...
    {$donnéé=$reclamationRepository->findAll();
    $reclamation=$paginator->paginate($donnéé, $request->query->getInt('page',1), 5);
